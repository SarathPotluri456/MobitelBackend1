...
public class CategoryController 
{
	...
	public String addCategory(@RequestParam("catid") String catid,@RequestParam("catname") String catname,@RequestParam("catdesc") String catdesc,Model m)
	{
	...
	public String deleteCategory(@PathVariable("catid") String catid,Model m)
	{
	...
	public String getUpdateCategory(@PathVariable("catid") String catid,Model m)
	{
		...
		boolean flag=true;
		m.addAttribute("flag",flag);
		System.out.println("--- Getting Category Object to be Created---");
